            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 pull-right">
						...
						@endif
						<form class="mt100 form-horizontal sign-up" role="form" method="POST" action="{{ url('/auth/login') }}">
                            ...
                            <p><input type="checkbox" class="form-Control" name="remember"> Remember Me</p>
